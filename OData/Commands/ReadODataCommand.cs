...
using KY.Generator.OData.TransferObjects;
using KY.Generator.Transfer;
using Microsoft.OData.Edm;
using Microsoft.OData.Edm.Csdl;

namespace KY.Generator.OData.Commands
{
    internal class ReadODataCommand : IConfigurationCommand
    {
