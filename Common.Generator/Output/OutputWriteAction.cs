...
public class OutputWriteAction : IOutputAction
{
    ...
    public OutputWriteAction(string filePath, string content, GeneratorOptions options, IEnvironment environment, Guid? outputId = null, bool forceOverwrite = false)
    {
    ...
    public void Execute()
    {
        ...
        bool contentReadIsGenerated = readOutputIds.Any() || OutputFileHelper.IsGeneratedFile(contentRead);
