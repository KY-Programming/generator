...
{
    public static string FormatFile(string name, GeneratorOptions options, string type = null, bool force = true)
    {
        return options.Language?.FormatFile(name, options, type, force) ?? Format(name, options.Formatting.FileCase, options, force);
    }

    public static string FormatClass(string name, GeneratorOptions options, bool force = false)
    {
        return Format(name, options.Formatting.ClassCase, options, force);
    }

    public static string FormatField(string name, GeneratorOptions options, bool force = false)
    {
        return Format(name, options.Formatting.FieldCase, options, force, options.Formatting.CaseMode);
    }

    public static string FormatProperty(string name, GeneratorOptions options, bool force = false)
    {
        return Format(name, options.Formatting.PropertyCase, options, force, options.Formatting.CaseMode);
    }

    public static string FormatMethod(string name, GeneratorOptions options, bool force = false)
    {
        return Format(name, options.Formatting.MethodCase, options, force);
    }

    public static string FormatParameter(string name, GeneratorOptions options, bool force = false)
    {
        return Format(name, options.Formatting.ParameterCase, options, force);
    }

    public static string Format(string name, string casing, GeneratorOptions options, bool force = false, CaseMode mode = CaseMode.Fix)
    {
    ...
    public static string Format(string name, string casing, GeneratorOptions options, CaseMode mode)
    {
