...
public static class TypeMappingExtension
{
    public static ITypeMapping Initialize(this ITypeMapping typeMapping)
    {
        typeMapping.Map<ReflectionLanguage>().To<CsharpLanguage>()
                   ...
                   .From("System.SByte").To("sbyte").FromSystem()
                   .From("System.Char").To("char").FromSystem()
                   .From("System.DateOnly").To("DateOnly").Namespace("System").FromSystem()
                   .From("System.DateTime").To("DateTime").Namespace("System").FromSystem()
                   .From("System.DateTimeOffset").To("DateTimeOffset").Namespace("System").FromSystem()
                   ...
                   .From("System.TimeOnly").To("TimeOnly").Namespace("System").FromSystem()
                   ...
                   .From("System.Uri").To("Uri").Namespace("System").Nullable().FromSystem()
                   .From("System.Version").To("Version").Namespace("System").Nullable().FromSystem()
        ...
        typeMapping.Map<ReflectionLanguage>().To<TypeScriptLanguage>()
                   ...
                   .From("System.SByte").To("number").Nullable().FromSystem().Default(Code.Instance.Number(0))
                   .From("System.Char").To("number").Nullable().FromSystem().Default(Code.Instance.Number(0))
                   .From("System.DateOnly").To("string").Nullable().FromSystem().Default(null, Code.Instance.String("0001-01-01"))
                   ...
                   .From("System.DateTimeOffset").To("string").Nullable().FromSystem().Default(null, Code.Instance.String("0001-01-01T00:00:00+00:00"))
                   ...
                   .From("System.Guid").To("string").Nullable().FromSystem().Default(null, Code.Instance.String("00000000-0000-0000-0000-000000000000"))
                   ...
                   .From("System.String").To("string").Nullable().FromSystem().Default(null, Code.Instance.String(string.Empty))
                   .From("System.TimeOnly").To("string").Nullable().FromSystem().Default(null, Code.Instance.String("00:00:00"))
                   .From("System.TimeSpan").To("string").Nullable().FromSystem().Default(null, Code.Instance.String("00:00:00"))
                   ...
                   .From("System.Uri").To("string").Nullable().FromSystem().Default(null, Code.Instance.String(string.Empty))
                   .From("System.Version").To("string").Nullable().FromSystem().Default(null, Code.Instance.String(string.Empty))
