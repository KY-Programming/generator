...
public class AspDotNetGeneratorControllerWriter : Codeable
{
    ...
    public virtual void Write(AspDotNetWriteConfiguration configuration, List<FileTemplate> files)
    {
        ...
        ClassTemplate classTemplate = files.AddFile(configuration.GeneratorController.RelativePath ?? configuration.RelativePath, generatorOptions)
                                           ...
                                           .FormatPrefix(generatorOptions)
                                           .WithUsing("System")
                                           .WithUsing("System.Linq")
                                           .WithUsing("KY.Generator")
                                           .WithUsing("KY.Generator.RelativePath");
