...
namespace KY.Generator.Reflection.Tests
{
    ...
    public class InterfaceTest : MsTestBase
    {
        ...
        {
            bool success = this.RunByTypeName(nameof(OneInterfaceType));
        ...
        {
            bool success = this.RunByTypeName(nameof(TwoInterfacesType));
            Assert.AreEqual(true, success, "Generation not successful");
        ...
        {
            bool success = this.RunByTypeName(nameof(InheritInterfaceType));
            Assert.AreEqual(true, success, "Generation not successful");
            Assert.AreEqual(3, this.output.Files.Count);
        ...
        [TestMethod]
        public void TestBaseClassAndOneInterface()
        {
            bool success = this.RunByTypeName(nameof(BaseClassAndOneInterfaceType));
            Assert.AreEqual(true, success, "Generation not successful");
        ...
        [TestMethod]
        public void TestBaseClassAndTwoInterfaces()
        {
            bool success = this.RunByTypeName(nameof(BaseClassAndTwoInterfacesType));
            Assert.AreEqual(true, success, "Generation not successful");
        ...
        {
            bool success = this.RunByTypeName(nameof(Types));
            Assert.AreEqual(true, success, "Generation not successful");
            Assert.AreEqual(2, this.output.Files.Count);
