...
namespace MyModule.Generator.Writers;
...
/// </summary>
internal class HelloWriter(IList<FileTemplate> files, Options options) : Codeable
{
    public void Write(SayHelloCommandParameters parameters)
    {
        ...
        // Naming the file is the writer's job. Formatter asks the language set in SayHelloCommand.Prepare()
        // how a file is named, so this comes out as GreeterGreeter.cs for C# and greeter-greeter.ts for
        // TypeScript - including the extension. Leave it out and the file is written without one.
