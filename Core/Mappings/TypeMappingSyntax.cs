...
namespace KY.Generator.Mappings
{
    internal class TypeMappingSyntax : ITypeMappingSyntax
    {
        ...
        private readonly ILanguage fromLanguage;
        private readonly string fromType;

        public TypeMappingSyntax(TypeMapping mapping, ILanguage fromLanguage, string fromType)
        {
        ...
        public void To(ILanguage toLanguage, string toType, string constructor = null)
        {
