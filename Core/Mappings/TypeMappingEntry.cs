...
namespace KY.Generator.Mappings
{
    public class TypeMappingEntry
    {
        ...
        public TypeMappingEntry(ILanguage fromLanguage, string fromType, ILanguage toLanguage, string toType, bool nullable, string nameSpace, string constructor = null)
        {
