...
export class ActionRouteTokensService {
    ...
    public get(httpOptions?: {}): Observable<string> {
        ...
        let url: string = this.serviceUrl + "/api/actionroutetokens/get";
    ...
    public getById(id: number, httpOptions?: {}): Observable<string> {
        let subject = new Subject<string>();
        httpOptions = { responseType: 'text', ...this.httpOptions, ...httpOptions};
        let url: string = this.serviceUrl + "/api/actionroutetokens/getbyid";
    ...
    public update(value: string, httpOptions?: {}): Observable<void> {
        ...
        let url: string = this.serviceUrl + "/api/actionroutetokens/update";
