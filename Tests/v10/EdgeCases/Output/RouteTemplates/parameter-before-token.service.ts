...
export class ParameterBeforeTokenService {
    ...
    public get(id: number, httpOptions?: {}): Observable<string> {
        let subject = new Subject<string>();
        httpOptions = { responseType: 'text', ...this.httpOptions, ...httpOptions};
        let url: string = this.serviceUrl + "/api/parameterbeforetoken";
    ...
    public getTail(id: number, name: string, httpOptions?: {}): Observable<string> {
        let subject = new Subject<string>();
        httpOptions = { responseType: 'text', ...this.httpOptions, ...httpOptions};
        let url: string = this.serviceUrl + "/api/parameterbeforetoken";
        url = this.append(url, id, undefined, "/");
