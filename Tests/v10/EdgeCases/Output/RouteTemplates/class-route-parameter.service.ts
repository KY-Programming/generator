...
export class ClassRouteParameterService {
    ...
    public getById(id: number, httpOptions?: {}): Observable<string> {
        ...
        let url: string = this.serviceUrl + "/api/classrouteparameter/getbyid";
    ...
    public updateById(id: number, value: string, httpOptions?: {}): Observable<void> {
        let subject = new Subject<void>();
        httpOptions = { ...this.httpOptions, ...httpOptions};
        let url: string = this.serviceUrl + "/api/classrouteparameter/updatebyid";
        url = this.append(url, id, undefined, "/");
