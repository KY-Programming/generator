...
export class TokenInTheMiddleService {
    ...
    public get(httpOptions?: {}): Observable<string> {
        ...
        let url: string = this.serviceUrl + "/api/tokeninthemiddle/get/details";
    ...
    public update(value: string, httpOptions?: {}): Observable<void> {
        ...
        let url: string = this.serviceUrl + "/api/tokeninthemiddle/update/details";
