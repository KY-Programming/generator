...
export class ClassRouteTokensService {
    ...
    public get(httpOptions?: {}): Observable<string> {
        ...
        let url: string = this.serviceUrl + "/api/v1/classroutetokens/get";
    ...
    public getWithMixedCaseName(httpOptions?: {}): Observable<string> {
        let subject = new Subject<string>();
        httpOptions = { responseType: 'text', ...this.httpOptions, ...httpOptions};
        let url: string = this.serviceUrl + "/api/v1/classroutetokens/getwithmixedcasename";
        this.http.get<string>(url, httpOptions).subscribe((result) => {
            subject.next(this.fixUndefined(result));
            subject.complete();
        }, (error) => subject.error(error));
    ...
    public search(filter: string, httpOptions?: {}): Observable<string> {
        let subject = new Subject<string>();
        httpOptions = { responseType: 'text', ...this.httpOptions, ...httpOptions};
        let url: string = this.serviceUrl + "/api/v1/classroutetokens/search";
    ...
    public update(value: string, httpOptions?: {}): Observable<void> {
        ...
        let url: string = this.serviceUrl + "/api/v1/classroutetokens/update";
