...
public class Types
{
    ...
    public Dictionary<string, SubType> StringSubTypeDictionary { get; set; } = new();
    public Dictionary<int, SubType> IntSubTypeDictionary { get; set; } = new();
    public Dictionary<SubType, string> SubTypeStringDictionary { get; set; } = new();
