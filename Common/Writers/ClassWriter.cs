...
public class ClassWriter : ITemplateWriter
{
    ...
    public ClassWriter(Options options)
    {
    ...
    public virtual void Write(ICodeFragment fragment, IOutputCache output)
    {
        ...
        if (generatorOptions.Formatting.CollapseEmptyClasses && output.LastFragments.First().Equals(template))
        {
            output.UnBreakLine();
            output.Add(generatorOptions.Formatting.CollapsedClassesSpacer, true);
        }
        output.EndBlock();
    }
}
