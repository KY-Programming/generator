...
internal class JsonReader : ITransferReader
{
    ...
    public void Read(JsonReadConfiguration configuration)
    {
        ...
        this.ReadModel(name, source).SetRoot();
    }

    private JsonModelTransferObject ReadModel(string name, JObject source)
    {
        JsonModelTransferObject model = new()
        {
            Name = name,
        ...
        foreach (JProperty property in source.Properties())
        {
            ...
            {
                TypeTransferObject listType = new()
                {
                    Name = nameof(JTokenType.Array)
                };
                model.Properties.Add(new PropertyTransferObject
                {
                    Name = property.Name,
